              ...
              <div className="vy-edu-card">
                ...
                <div style={{ display:"flex", alignItems:"flex-start", gap:"14px" }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontSize:"13px", fontWeight:600, color:"rgba(250,204,21,0.8)", margin:"0 0 8px" }}>
                      {edu.institution || edu.school}
                    </p>
                    {edu.description && (
                      <p style={{ fontSize:"13px", color:"rgba(250,250,245,0.45)", lineHeight:1.6, margin:0 }}>{edu.description}</p>
                    )}
                    {edu.gpa && (
