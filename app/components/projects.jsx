          ...
          {items.map((proj, i) => (
            ...
            >
              <div className="vy-proj-card">
                {proj.imageBase64 && (
                  <div style={{ width: "100%", height: "150px", overflow: "hidden", marginBottom: "1rem" }}>
                ...
                <div style={{ display:"flex", alignItems:"flex-start", justifyContent:"space-between", marginBottom:"0.25rem" }}>
                  ...
                  <div style={{ display:"flex", gap:"12px", paddingTop:"4px" }}>
                    ...
                    {(proj.link || proj.demo) && (
                      <a href={proj.link || proj.demo} target="_blank" rel="noopener noreferrer" className="vy-proj-link" aria-label="Live demo">
